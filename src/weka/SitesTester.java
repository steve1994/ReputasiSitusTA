...
//        String pathClassifierDangerousType2 = "database/weka/model/num_" + optimumTrainingKNN + ".type_" + typeReputation + ".dangerousityKNN.hybrid.model";
